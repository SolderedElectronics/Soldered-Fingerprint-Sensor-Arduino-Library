# Fingerprint sensor adapter Arduino library
...
### Hardware design
You can find hardware design for this board in [*Fingerprint sensor adapter*](https://github.com/SolderedElectronics/NAZIVPROIZVODA-hardware-design) hardware repository.
